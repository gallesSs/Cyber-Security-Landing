  ...
  return (
    <section
      ...
      <div className="relative md:w-[1211px] mx-auto">
        ...
        {/* ✅ Кастомные стрелки */}
        <button className="swiper-button-prev-custom absolute left-[-60px] top-1/2 -translate-y-1/2 z-10 text-white text-4xl hover:text-blue-500 transition-colors">
          ‹
        </button>
        <button className="swiper-button-next-custom absolute right-[-60px] top-1/2 -translate-y-1/2 z-10 text-white text-4xl hover:text-blue-500 transition-colors">
          ›
        </button>
      </div>
    </section>
